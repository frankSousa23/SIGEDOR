    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200">
        <div>
          <h2 className="text-xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
            <GraduationCap className="w-5 h-5 text-unerg-blue" />
            Expedientes Docentes Universitarios
          </h2>
          <p className="text-xs text-slate-500">
            Catálogo institucional y registro de personal académico UNERG ({filtered.length} registrados)
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-50 border border-slate-300 rounded-lg shadow-xs flex items-center gap-1.5 transition-colors"
          >
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs flex flex-wrap gap-2.5 items-center">
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            type="text"
            placeholder="Buscar por nombre, apellido, cédula o cátedra..."
            value={searchQuery}
        ...
        {(searchQuery || selectedSede || selectedCategory || selectedDedication) && (
          <button
            ...
            className="text-xs text-red-600 hover:text-red-800 font-semibold px-2 py-1 flex items-center gap-1"
          >
      ...
      {/* Teachers Table (Filament Resource style) */}
