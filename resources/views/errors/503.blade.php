...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>503 - Servicio no Disponible | SIGEDOR</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col items-center justify-center min-h-[80vh] text-center">
                    <div class="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 shadow-xl max-w-2xl">
                        ...
                        <h2 class="text-2xl font-semibold text-blue-400 mb-4">Servicio no Disponible</h2>
                        <p class="text-slate-300 text-lg mb-8">
                            El sistema se encuentra temporalmente en mantenimiento.
                            Por favor, intenta acceder más tarde. Disculpa las molestias.
                        </p>
                        <div class="text-slate-400 text-sm mt-4">
                            Tiempo estimado de espera: {{ isset($exception) && $exception->retryAfter ? $exception->retryAfter : '15' }} minutos
                        </div>
                    </div>
                </div>
            </div>
