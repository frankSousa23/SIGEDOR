...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>429 - Demasiadas Solicitudes | SIGEDOR</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col items-center justify-center min-h-[80vh] text-center">
                    <div class="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 shadow-xl max-w-2xl">
                        ...
                        <h1 class="text-6xl font-bold text-white mb-4">429</h1>
                        <h2 class="text-2xl font-semibold text-blue-400 mb-4">Demasiadas Solicitudes</h2>
                        ...
                        <div class="text-slate-400 text-sm mt-4">
                            Intenta nuevamente en: {{ isset($exception) && $exception->retryAfter ? $exception->retryAfter : '60' }} segundos
                        </div>
                    </div>
                </div>
            </div>
